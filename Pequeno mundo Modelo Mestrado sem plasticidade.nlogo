...
to output
  ...
  let filename (word ticks "noplasticity_nocost_" "foodsheep" sheep-gain-from-food "_" "foodwolf" wolf-gain-from-food"_" "reproduce" "s" sheep-reproduce "w" wolf-reproduce "_"
...
@#$#@#$#@
<experiments>
  <experiment name="Simulação FINAL (resultados)" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="Estabilidade" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>output</final>
    <timeLimit steps="498"/>
