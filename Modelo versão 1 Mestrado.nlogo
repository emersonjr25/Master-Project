...
to setup ; configuração inicial do sistema
  ...
  [
   ...
   create-wolvestwo 100 ; create the first wolves, then initialize their variables
  [
    set shape "wolf"
    set color pink
    set size 1.5  ; easier to see
  ...
  create-wolvesthree 100 ; create the first wolves, then initialize their variables
  [
    set shape "wolf"
    set color magenta
    set size 1.5  ; easier to see
  ...
  create-wolvesfour 100 ; create the first wolves, then initialize their variables
  [
    set shape "wolf"
    set color yellow
    set size 1.5  ; easier to see
