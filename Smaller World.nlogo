...
to move  ; turtle procedure
  ...
  let dist 0
  ;fd 1 + x
  ifelse any? Patches in-radius salto with [pcolor = black]
  [
   set alvo one-of patches in-radius salto with [cell-impacted = 0]
   ifelse alvo != nobody [move-to alvo ] [fd 1 + x]
   ;set  x floor distance alvo ;;floor rounds down the number
  ]
  [fd 1 + x]
...
;LOAD-PATCH-DATA
  ...
  let file (word "0.30_030_00" rep ".txt")
    let filename (word "C:/Users/emers/Dropbox/Coisas minhas/Mestrado e doutorado em Ecologia - UFBA/Projeto plasticidade/50x50/habitat_destruidof03p30/" file)
  ...
  let file (word "0.70_030_00" rep ".txt")
    let filename (word "C:/Users/emers/Dropbox/Coisas minhas/Mestrado e doutorado em Ecologia - UFBA/Projeto plasticidade/50x50/habitat_destruidof07p30/" file)
  ...
  let filename (word "C:/Users/emers/Dropbox/Coisas minhas/Mestrado e doutorado em Ecologia - UFBA/Projeto plasticidade/50x50/habitat_destruidof03p75/" file)
  ...
  let filename (word "C:/Users/emers/Dropbox/Coisas minhas/Mestrado e doutorado em Ecologia - UFBA/Projeto plasticidade/50x50/habitat_destruidof07p75/" file)
...
@#$#@#$#@
<experiments>
  <experiment name="PrimeiroExperimento" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>output</final>
    <timeLimit steps="498"/>
  ...
  <experiment name="Variando plasticidade custo alto" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>output</final>
    <timeLimit steps="498"/>
  ...
  <experiment name="Variando plasticidade custo baixo" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>output</final>
    <timeLimit steps="498"/>
